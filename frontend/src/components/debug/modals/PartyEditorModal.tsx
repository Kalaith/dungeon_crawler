                    ...
                    <div>
                        ...
                        >
                            {activeMembers.map(({ c, i }) => (
                                <option key={i} value={i}>{c!.name} (Lvl {c!.level} {c!.class.name})</option>
                            ))}
                        </select>
                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={editValues.hp}
                                        onChange={(e) => setEditValues({ ...editValues, hp: parseInt(e.target.value) })}
                                        className="w-full bg-gray-800 border border-gray-600 text-white rounded p-2"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={editValues.ap}
                                        onChange={(e) => setEditValues({ ...editValues, ap: parseInt(e.target.value) })}
                                        className="w-full bg-gray-800 border border-gray-600 text-white rounded p-2"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setEditValues({ ...editValues, gold: parseInt(e.target.value) })}
                                        className="w-full bg-gray-800 border border-gray-600 text-white rounded p-2"
                                    />
                                </div>
                            </div>
