...
export const TownHub: React.FC = () => {
  ...
  const services = [
    ...
    {
      id: 'temple' as ServiceId,
      name: 'Temple',
      icon: '⛪',
      available: true,
      description: 'Blessings and resurrection',
    },
    {
      id: 'healer' as ServiceId,
      name: 'Healer',
      icon: '⚕️',
      available: true,
      description: 'Cure wounds and diseases',
    },
    {
      id: 'blacksmith' as ServiceId,
      name: 'Blacksmith',
      icon: '⚒️',
      available: true,
      description: 'Repair and upgrade equipment',
    },
  ];
    ...
    <div className="h-full w-full overflow-y-auto bg-etrian-900 p-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-center gap-4">
          <Button variant="outline" size="lg" onClick={handleLeaveToOverworld}>
            ← Leave Town
          </Button>
        </div>
        ...
        <div className="mt-6 bg-etrian-800 rounded-xl p-6 shadow-lg border border-cyan-900/50">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-semibold text-green-500">Safe Haven</p>
            </div>
          </div>
        </div>
      </div>
