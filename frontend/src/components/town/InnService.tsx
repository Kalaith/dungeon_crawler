          ...
          {!hasRested ? (
            <>
              ...
              <p className="text-cyan-100 mb-6">
                A warm bed and a hot meal await you. Rest here to fully restore
                your party's health and energy.
              </p>
              ...
              <div className="bg-etrian-700 rounded-lg p-6 mb-6 border-2 border-gold-500/30">
                ...
                <div className="bg-green-900/30 rounded p-3 mb-4 border border-green-500/30">
                  <p className="text-sm text-green-400">
                    ✨ <strong>Benefits:</strong> Fully restores HP and AP for
                    all party members
                  </p>
                </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex gap-4">
                            <span
                              className={
                                needsHealing ? 'text-red-400' : 'text-green-400'
                              }
                            >
            ...
            <div className="text-center py-8">
              ...
              <p className="text-cyan-100 mb-6">
                Your party has rested well. Everyone feels refreshed and ready
                for adventure!
              </p>
