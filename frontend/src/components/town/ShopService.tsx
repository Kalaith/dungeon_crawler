    ...
    cart.forEach((quantity, itemId) => {
      ...
      if (shopItem) {
        const item: Item = {
          ...
          name: shopItem.name,
          type:
            shopItem.category === 'potions'
              ? 'consumable'
              : shopItem.category === 'weapons'
                ? 'weapon'
                : shopItem.category === 'armor'
                  ? 'armor'
                  : 'material',
