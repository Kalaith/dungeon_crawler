...
export const useWorldStore = create<WorldStore>()(
    persist(
        (set, get) => ({
            ...
            // Actions
            setCurrentLocation: (locationId: string) => set((state) => {
            ...
            discoverLocation: (locationId: string) => set((state) => {
                if (state.worldMap.discoveredLocations.includes(locationId)) {
                    return state;
                }
            ...
            unlockLocation: (locationId: string) => set((state) => {
            ...
            completeDungeon: (dungeonId: string) => set((state) => {
                const updatedLocations = state.worldMap.locations.map(loc => {
            ...
            startTravel: (fromId: string, toId: string) => set((state) => {
            ...
            updateTravelProgress: (progress: number) => set((state) => {
