...
describe('Character Creation Store', () => {
    ...
    describe('Point-Buy System', () => {
        ...
        it('should increase attribute and decrease points', () => {
            ...
            expect(useCharacterCreationStore.getState().attributePointsRemaining).toBeLessThan(initialPoints);
        });
        ...
        it('should not allow spending more points than available', () => {
            ...
            expect(useCharacterCreationStore.getState().attributePointsRemaining).toBeGreaterThanOrEqual(0);
        });
    });
