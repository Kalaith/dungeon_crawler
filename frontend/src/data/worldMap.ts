...
export const startingWorldMap: WorldMap = {
  ...
  locations: [
    // Starting Town
    {
      ...
      description:
        'A peaceful village nestled in the valley. A good place to rest and resupply before venturing into the unknown.',
      discovered: true,
      accessible: true,
      icon: 'town',
      townData: {
    ...
    // Tutorial Dungeon
    {
      ...
      description:
        'A small cave system infested with goblins. Local farmers have reported missing livestock. Good for beginners.',
      discovered: true,
      accessible: true,
      icon: 'cave',
      dungeonData: {
    ...
    // Second Town (unlocked after tutorial)
    {
      ...
      description:
        'A bustling market town by the river. Merchants from far and wide gather here to trade.',
      discovered: false,
      accessible: false,
      icon: 'town',
      townData: {
    ...
    // Main Dungeon
    {
      ...
      description:
        'Crumbling stone structures from a forgotten civilization. Strange magical energies emanate from within.',
      discovered: false,
      accessible: false,
      icon: 'ruins',
      dungeonData: {
    ...
    // Wilderness Area
    {
      ...
      description:
        'A dense, foreboding forest. Strange sounds echo through the trees. Travelers are advised to stay on the path.',
      discovered: false,
      accessible: true,
      icon: 'forest',
      wildernessData: {
