...
export const races: Race[] = [
    ...
    },
    {
        id: 'elf',
        name: 'Elf',
        description: 'Graceful and long-lived, elves are at home in nature and magic. Known for their keen senses and intuition.',
        attributeModifiers: {
            DX: 2,
            IT: 1,
            CO: -1
    ...
    },
    {
        id: 'grung',
        name: 'Grung',
        description: 'Small, poisonous frog-like humanoids from tropical jungles. Fiercely territorial and caste-bound.',
        attributeModifiers: {
            DX: 2,
            CO: 1
        },
    ...
    },
    {
        id: 'aarakocra',
        name: 'Aarakocra',
        description: 'Birdfolk from the Elemental Plane of Air. Cherish freedom and the open sky above all else.',
        attributeModifiers: {
            DX: 2,
            WD: 1
        },
    ...
    },
    {
        id: 'changeling',
        name: 'Changeling',
        description: 'Shapeshifters who can alter their appearance at will. Often hide their true nature behind many masks.',
        attributeModifiers: {
            CH: 2
        },
        abilities: [
    ...
    },
    {
        ...
        description: 'Serpent-blooded humans who view emotions as weakness. Masters of poison and magic resistance.',
        attributeModifiers: {
            CH: 2,
            IT: 1
        },
    ...
    },
    {
        id: 'centaur',
        name: 'Centaur',
        description: 'Upper body of a human, lower body of a horse. Nature wardens with immense speed and charge attacks.',
        attributeModifiers: {
            ST: 2,
            WD: 1
        },
        abilities: [
            ...
            },
            {
                id: 'equine_build',
                name: 'Equine Build',
                description: 'Count as one size larger for carrying capacity. Climbing costs extra movement.',
                unlockLevel: 1,
                target: 'self'
            },
            {
    ...
    },
    {
        id: 'bugbear',
        name: 'Bugbear',
        description: 'Massive, hairy goblinoids born for stealth and ambush. Surprisingly quiet for their size.',
        attributeModifiers: {
            ST: 2,
            DX: 1
        },
    ...
    },
    {
        ...
        abilities: [
            ...
            },
            {
                ...
                description: 'Fey Step gains additional effects based on current season (Spring, Summer, Autumn, Winter).',
                unlockLevel: 3,
                target: 'self'
            }
        ],
    ...
    },
    {
        id: 'githyanki',
        name: 'Githyanki',
        description: 'Astral warriors who were once enslaved by mind flayers. Raiders of the multiverse.',
        attributeModifiers: {
            ST: 2,
            IT: 1
        },
    ...
    },
    {
        id: 'verdan',
        name: 'Verdan',
        description: 'Goblinoids transformed by chaotic energy. They evolve and mutate as they level up.',
        attributeModifiers: {
            CO: 2,
            CH: 1
        },
    ...
    },
    {
        id: 'satyr',
        name: 'Satyr',
        description: 'Fey creatures who revel in nature and music. Resistant to magic and naturally nimble.',
        attributeModifiers: {
            CH: 2,
            DX: 1
        },
    ...
    },
    {
        id: 'firbolg',
        name: 'Firbolg',
        description: 'Gentle giant-kin of the forests. Can speak with plants and animals and turn invisible briefly.',
        attributeModifiers: {
            WD: 2,
            ST: 1
        },
    ...
    },
    {
        id: 'kobold',
        name: 'Kobold',
        description: 'Small reptilian humanoids. Weak individually but deadly in groups thanks to pack tactics.',
        attributeModifiers: {
            DX: 2,
            ST: -2
        },
    ...
    },// Uncommon Races
    {
        id: 'azarketi',
        name: 'Azarketi',
        description: 'Aquatic humanoids adapted to life underwater. Amphibious beings with gills and webbed extremities.',
        attributeModifiers: {
            CO: 2,
            CH: 1,
            WD: -1
    ...
    },
    {
        id: 'hobgoblin',
        name: 'Hobgoblin',
        description: 'Disciplined warrior humanoids who value military precision and tactical superiority.',
        attributeModifiers: {
            CO: 2,
            IT: 1,
            CH: -1
    ...
    // Rare Races
    {
        id: 'android',
        name: 'Android',
        description: 'Artificial humanoids created through advanced technology. Emotionally reserved but highly logical.',
        attributeModifiers: {
            IT: 2,
            DX: 1,
            CH: -1
